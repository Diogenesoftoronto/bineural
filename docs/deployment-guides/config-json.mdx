...
<Note>
**Full schema reference:** [`https://raw.githubusercontent.com/maximhq/bifrost/main/config.schema.json`](https://raw.githubusercontent.com/maximhq/bifrost/main/config.schema.json)
</Note>

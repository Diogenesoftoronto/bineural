...
<Note>
All enterprise features are included in Bifrost. Set `enable_enterprise: true` in your `config.json` to activate them.
</Note>
...
Open a [GitHub Issue](https://github.com/maximhq/bifrost/issues) for support.

...
<Note>
The live schema is published at [`https://raw.githubusercontent.com/maximhq/bifrost/main/config.schema.json`](https://raw.githubusercontent.com/maximhq/bifrost/main/config.schema.json). Add `"$schema": "https://raw.githubusercontent.com/maximhq/bifrost/main/config.schema.json"` to your `config.json` for IDE autocomplete and inline validation.
</Note>
...
|-----|------|-------------|-------|
| `$schema` | string | Schema URL for IDE validation. Set to `"https://raw.githubusercontent.com/maximhq/bifrost/main/config.schema.json"` | - |

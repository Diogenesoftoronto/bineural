...
Once configured, monitor your AI apps in the [Maxim Dashboard](https://github.com/maximhq/bifrost/wiki/Maxim-Observability). Maxim is an end-to-end evaluation & observability platform built to help teams ship AI agents faster while maintaining high quality.

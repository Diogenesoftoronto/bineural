...
<CardGroup cols={2}>
  <Card title="Enable Enterprise" icon="rocket" href="/enterprise/clustering">
    Set `enable_enterprise: true` in config.json to activate all enterprise features.
  </Card>
  <Card title="Configuration" icon="gear" href="/deployment-guides/config-json/plugins">
    Enterprise features are configured through the standard plugins config.
  </Card>
</CardGroup>

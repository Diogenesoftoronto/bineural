...
const (
	...
	BifrostContextKeyProviderEnergyConsumption       BifrostContextKey = "bifrost-provider-energy-consumption"     // *EnergyConsumption (set by openai-style providers from response headers like x-energy-used, x-request-cost-usd)

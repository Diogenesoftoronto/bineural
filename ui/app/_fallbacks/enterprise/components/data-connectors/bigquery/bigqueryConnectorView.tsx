...
export default function bigqueryConnectorView() {
	...
	const mockItems = [
		{ id: "1", name: "connector:bq-analytics", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "connector:bq-analytics", status: "active", updated: "2026-04-29" },
	];
	...
	return (
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					<h2 className="text-lg font-semibold">BigQuery Connector</h2>
					<p className="text-sm text-muted-foreground">Export logs and analytics data to Google BigQuery</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create BigQuery Connecto</DialogTitle></DialogHeader>

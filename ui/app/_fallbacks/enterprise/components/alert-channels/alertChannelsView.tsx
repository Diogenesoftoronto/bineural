...
export default function alertChannelsView() {
	...
	const mockItems = [
		{ id: "1", name: "webhook:prod-hook", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "slack:ops-channel", status: "active", updated: "2026-04-29" },
	];
		...
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">Configure notification channels for alerts and incidents</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create Alert Channel</DialogTitle></DialogHeader>

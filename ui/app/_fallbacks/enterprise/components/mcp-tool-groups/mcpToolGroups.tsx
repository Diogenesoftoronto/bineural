...
export default function mcpToolGroups() {
	...
	const mockItems = [
		{ id: "1", name: "group:search-tools", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "group:code-tools", status: "active", updated: "2026-04-29" },
	];
	...
	return (
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					<h2 className="text-lg font-semibold">MCP Tool Groups</h2>
					<p className="text-sm text-muted-foreground">Organize MCP tools into groups for access control</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create MCP Tool Group</DialogTitle></DialogHeader>

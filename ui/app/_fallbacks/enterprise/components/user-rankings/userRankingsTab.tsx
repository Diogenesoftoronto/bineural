...
export default function userRankingsTab() {
	...
	const mockItems = [
		{ id: "1", name: "rank:top-users", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "rank:by-spend", status: "active", updated: "2026-04-29" },
	];
	...
	return (
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					<h2 className="text-lg font-semibold">User Rankings</h2>
					<p className="text-sm text-muted-foreground">View user activity rankings and usage metrics</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create User Ranking</DialogTitle></DialogHeader>

...
export default function accessProfilesIndexView() {
	...
	const mockItems = [
		{ id: "1", name: "profile:ml-team", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "profile:api-prod", status: "active", updated: "2026-04-29" },
	];
	...
	return (
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					<h2 className="text-lg font-semibold">Access Profiles</h2>
					<p className="text-sm text-muted-foreground">Configure scoped access profiles with budgets and rate limits</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create Access Profile</DialogTitle></DialogHeader>

...
export default function PromptDeploymentView({ omitTitle }: { omitTitle?: boolean } = {}) {
	...
	const mockItems = [
		{ id: "1", name: "deploy:prod-v2", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "deploy:canary-v3", status: "active", updated: "2026-04-29" },
	];
		...
		<div className="flex h-full flex-col gap-6 p-6">
			{!omitTitle && (
				<div className="flex items-center justify-between">
					<div>
						<h2 className="text-lg font-semibold">Prompt Deployments</h2>
						<p className="text-sm text-muted-foreground">Manage prompt versioning, A/B testing, and canary deployments</p>
					</div>
					<Dialog open={showCreate} onOpenChange={setShowCreate}>
						...
						<DialogContent>
							<DialogHeader><DialogTitle>Create Prompt Deployment</DialogTitle></DialogHeader>

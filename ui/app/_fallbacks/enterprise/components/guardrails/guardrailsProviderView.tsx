...
export default function guardrailsProviderView() {
	...
	const mockItems = [
		{ id: "1", name: "provider:llamaguard", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "provider:perspective", status: "active", updated: "2026-04-29" },
	];
		...
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">Configure guardrail service providers for content filtering</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create Guardrail Provider</DialogTitle></DialogHeader>

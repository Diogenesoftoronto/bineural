...
export default function piiRedactorRulesView() {
	...
	const mockItems = [
		{ id: "1", name: "rule:ssn-detect", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "rule:email-mask", status: "active", updated: "2026-04-29" },
	];
	...
	return (
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					<h2 className="text-lg font-semibold">PII Redaction Rules</h2>
					<p className="text-sm text-muted-foreground">Define patterns and rules for detecting and redacting PII</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create PII Redaction Rule</DialogTitle></DialogHeader>

...
export default function piiRedactorProviderView() {
	...
	const mockItems = [
		{ id: "1", name: "provider:presidio", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "provider:aws-comprehend", status: "active", updated: "2026-04-29" },
	];
	...
	return (
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					<h2 className="text-lg font-semibold">PII Redaction Providers</h2>
					<p className="text-sm text-muted-foreground">Configure PII detection service providers</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create PII Redaction Provider</DialogTitle></DialogHeader>

...
export function BusinessUnitsView() {
	...
	const mockItems = [
		{ id: "1", name: "unit:engineering", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "unit:sales", status: "active", updated: "2026-04-29" },
	];
		...
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">Organize users into business units for governance and reporting</p>
				</div>

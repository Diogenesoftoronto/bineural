...
export default function usersView() {
	...
	const mockItems = [
		{ id: "1", name: "user:alice", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "user:bob", status: "active", updated: "2026-04-29" },
	];
		...
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">Manage users, set per-user budgets and rate limits, and control access</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create User Governanc</DialogTitle></DialogHeader>

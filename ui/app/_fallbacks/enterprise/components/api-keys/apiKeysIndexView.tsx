...
export default function apiKeysIndexView() {
	const [showCreate, setShowCreate] = useState(false);

	const mockItems = [
		{ id: "1", name: "key:prod-read", status: "active", updated: "2026-04-30" },
		{ id: "2", name: "key:staging-admin", status: "active", updated: "2026-04-29" },
	];
		...
		<div className="flex h-full flex-col gap-6 p-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">Create and manage API keys with granular scope-based access control</p>
				</div>
				<Dialog open={showCreate} onOpenChange={setShowCreate}>
					...
					<DialogContent>
						<DialogHeader><DialogTitle>Create Scoped API Key</DialogTitle></DialogHeader>
